...
<html lang="en">
 ...
 -->
	...
	<div id="post1" >
				<br><pre>	Your Wishlist</pre><br><br>
		...
		<?php
			if((isset($_SESSION["userid"]))==true)
			{
				...
				else
				{
						...
						$sql="SELECT * FROM wishlist w, advertisements a where w.postID=a.postID and w.userID=$uid and w.tableID=1"; 
						...
						$sql="SELECT * FROM wishlist w, jobs_gigs a where w.postID=a.postID and w.userID=$uid and w.tableID=2"; 
						$res=mysqli_query($conn,$sql);
						if(mysqli_num_rows($res)>0) 
						{
							while($row=$res->fetch_assoc())
						...
						if($count>1)
						{
							echo "<div class=\"detail_link\">Sorry, you have not wishlisted any items</div>";
						}
