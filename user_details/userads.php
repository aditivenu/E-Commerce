...
<html lang="en">
 ...
 -->
		...
		<title>User Advertisements</title>
		<meta charset="UTF-8">
	</head>
	<body >
		<div id= "header" >
		...
		<?php
			if((isset($_SESSION["userid"]))==true)
			{
				...
				else
				{
						...
						$sql="SELECT * FROM advertisements where userID=$uid"; 
						...
						if(mysqli_num_rows($res)>0) 
						{
							...
							{	
								...
								{
									echo "<div ><a href=\"http://localhost/craiglist/ads/1/".$row["postID"]."\" class=\"detail_link\" style=\"color:green;\">".$row["title"]."</a></div><br/><br/>";
								}
								...
								else
								{
									...
									{
										echo "<div ><a href=\"http://localhost/craiglist/ads/1/".$row["postID"]."\" class=\"detail_link\" style=\"color:red;\">".$row["title"]."</a></div><br/><br/>";
						...
						$sql="SELECT * FROM jobs_gigs where userID=$uid"; 
						$res=mysqli_query($conn,$sql);
						if(mysqli_num_rows($res)>0) 
						{
							while($row=$res->fetch_assoc())
							{	
								...
								if($row["status"]=="active")
								{
									echo "<div ><a href=\"http://localhost/craiglist/ads/2/".$row["postID"]."\" class=\"detail_link\" style=\"color:green;\">".$row["title"]."</a></div><br/><br/>";
								}
								...
								else
								{
									...
									{
										echo "<div ><a href=\"http://localhost/craiglist/ads/2/".$row["postID"]."\" class=\"detail_link\" style=\"color:red;\">".$row["title"]."</a></div><br/><br/>";
						...
						if($count>1)
						{
							echo "<div class=\"detail_link\">Sorry, you have not published any advertisement</div>";
						}
